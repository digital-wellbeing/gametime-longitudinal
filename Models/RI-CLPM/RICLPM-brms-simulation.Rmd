...
I don't brms can handle the RICLPM data, but let's try. We can manually center the variables within subjects, however, this shouldn't work ("dynamic panel bias")...
...
# Long format?
Not sure it'd solve the problem... Couldn't even get CLPM to work.