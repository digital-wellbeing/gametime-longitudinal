...
I've set the response rate to 3%, and use a logistic function to conver $\text{game time}_{t - i} \rightarrow \text{well-being}_t$ into individual probabilities of joining the study.
