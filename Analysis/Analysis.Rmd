...
p_lagged_scatter
ggsave(here("Output/Figures/Figure-2-raw.png"), width = 5, height = 4)
d_riclpm %>%
...
ggsave(here("Output/Figures/Figure-2-centered.png"), width = 5, height = 4)
```
...
ggsave(here("Output/Figures/Figure-4.png"), width = 6, height = 6)
```
...
ggsave(here("Output/Figures/Figure-5.png"), width = 8, height = 6)
```
