...
d_model %>%
  ...
  scale_x_continuous(
    "Estimated effect (95%CI) of 10 hours played",
    breaks = pretty_breaks()
  ) +
  geom_pointrangeh(
...
ggsave(here("Figure-3-Unstandardized.png"), width = 8, height = 4.6)
forest_plot("Standardized")
ggsave(here("Figure-3-Standardized.png"), width = 8, height = 4.6)
```
