...
```{r raw-session-duration-histograms, fig.cap = "Histograms of individual session durations before cleaning."}
d_t %>% 
  ggplot(aes(Hours)) +
  geom_histogram() +
  scale_y_log10() +
...
d %>% 
  ...
  as_gt() %>% 
  tab_header(
    title = "Numbers (%) of person-waves with more than 16h/day of play"
  )
