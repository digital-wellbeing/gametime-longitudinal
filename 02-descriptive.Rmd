...
```{r response-date-histograms, fig.height = 8, fig.cap = "Histograms of response dates."}
d %>%
  filter(Responded) %>% 
...
```{r response-time-histograms, fig.height = 8, fig.width = 8, fig.cap = "Histograms of response times (in UTC)."}
d %>% 
  filter(Responded) %>% 
...
```{r intervals-between-waves-histogram, fig.width = 8, fig.height = 8, fig.cap = "Histograms of intervals between participants completing the survey waves (in days)."}
d %>%
