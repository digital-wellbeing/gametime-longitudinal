...
#| fig.height: 6
#| fig.cap: >
#|  Results from the missing data sensivitity analysis. Coefficients plus 95% CIs for each imputation when delta = -1
all %>%
...
#| fig.height: 10
#| fig.cap: >
#|  Coefficients plus 95% CIs for the pooled MI models
pooled %>%
  tibble() %>% 
  ...
  labs(x = "Delta adjustment", y = "Estimate") +
