...
if(file.exists(data_path)) {
  ...
  stop("'Data/cleaned_data.rds' doesn't exist, run `01-clean.Rmd` to create it.")
}
...
```{r riclpm-data-figure-2, fig.width = 8, fig.height = 9}
p_tmp_1 / p_tmp_2
```
...
file_path <- here("Data", "brms-meta-analyses.rds")
